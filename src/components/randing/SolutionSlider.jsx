...
const SolutionSlider = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('orientationchange', () => {
      setTimeout(checkScreenSize, 350);
    });
  ...
  const solutionData = [
    {
      id: 1,
      question: {
        image: '/src/assets/images/환경문제1img.png',
    ...
    },
    {
      id: 2,
      question: {
        image: '/src/assets/images/환경문제2img.png',
        alt: '태평양 쓰레기 섬',
    ...
    },
    {
      id: 3,
      question: {
        image: '/src/assets/images/환경문제3img.png',
        alt: '지구 열대화와 기후 위기',
            ...
            <div className="blog-slider__item">
              <article className="q-card">
                ...
                <div className="q-card__body">
                  ...
                  <p 
                    className="q-desc"
                    dangerouslySetInnerHTML={{ __html: item.question.description }}
                  />
                </div>
              </article>
