      ...
      <div className="row">
        ...
        <div className="col-md-6">
          <div className="settings-section">
            ...
            <InputField
              ...
              inputChange={handleSystemSettingChange}
            />
            ...
            <InputField
              label="포인트 적립률 (기부 1kg당)"
              type="number"
              name="pointRate"
              value={systemSettings.pointRate}
              placeholder="포인트 적립률"
              inputChange={handleSystemSettingChange}
            />
            ...
            <button 
              className="btn default main1 mt-3"
        ...
        <div className="col-md-6">
          <div className="settings-section">
            ...
            <InputCheckPassword
              value1={adminPassword.newPassword}
              value2={adminPassword.confirmPassword}
              inputChange={handlePasswordChange}
            />
