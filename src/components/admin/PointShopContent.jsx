...
const PointShopContent = () => {
   ...
   return (
      <div className="pointshop-content">
         ...
         {/* 상품 관리 모달 */}
         <AdminBaseModal isOpen={showModal} onClose={() => setShowModal(false)} title={activeSubTab === 'pointshop-management' ? (modalType === 'add' ? '포인트샵 상품 추가' : '포인트샵 상품 수정') : modalType === 'add' ? '아나바다 상품 추가' : '아나바다 상품 수정'} size="lg">
                  ...
                  <div className="row">
                     ...
                     {activeSubTab === 'pointshop-management' && (
                        <div className="col-md-6">
                           <FormSelect label="브랜드" value={formData.brand} onChange={(e) => handleFormChange('brand', e.target.value)} options={partnerBrands} placeholder="브랜드 선택" required={true} />
                        </div>
                     )}
                  ...
                  <div className="mt-4 pt-4 border-top">
                     ...
                     <div className="mt-3">
                        ...
                        <div className="d-flex gap-2 flex-wrap">
                           <button className="btn default main1" style={{ fontSize: '0.85rem', padding: '6px 12px' }}>
                              승인
                           </button>
                           <button className="btn default main3" style={{ fontSize: '0.85rem', padding: '6px 12px' }}>
                              거부
                           </button>
                           <button className="btn default main2" style={{ fontSize: '0.85rem', padding: '6px 12px' }}>
                              블라인드
                           </button>
                           <button className="btn default" style={{ fontSize: '0.85rem', padding: '6px 12px' }}>
                              판매자 연락
                           </button>
                           <button className="btn default" style={{ fontSize: '0.85rem', padding: '6px 12px' }}>
                              신고 내역 보기
