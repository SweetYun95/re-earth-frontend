                  ...
                  <div className="dropdown-content">
                    <div className="content-section">
                      <div className="section-meta">
                        <span>우선순위: <span className={`priority ${item['우선순위'] === '높음' ? 'high' : item['우선순위'] === '보통' ? 'normal' : 'low'}`}>{item['우선순위']}</span></span>
                    ...
                    <div className="action-buttons">
                      <button 
                        ...
                        onClick={() => handleInquiryAction('answer', item)}
                      >
                        답변 작성
                      </button>
                      <button 
                        className="btn default main2"
                        onClick={() => handleInquiryAction('edit', item)}
                      >
                        수정
                      </button>
                      <button 
                        className="btn default main3"
                        onClick={() => handleInquiryAction('delete', item)}
                      >
                        삭제
                      </button>
                      <button 
                        className="btn default"
                        onClick={() => handleInquiryAction('assign', item)}
                      >
                        담당자 지정
                      </button>
                    </div>
