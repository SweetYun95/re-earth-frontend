         ...
         <div className="container">
            <div className="row d-flex">
               ...
               <aside className="col-lg-3 col-md-4 admin-page__sidebar">
                  <div className="admin-page__sidebar__contents">
                     ...
                     <nav className="admin-page__nav">
                        {tabs.map((tab) => (
                           <button key={tab.id} className={`admin-page__nav-item ${activeTab === tab.id ? 'admin-page__nav-item--active' : ''}`} onClick={() => setActiveTab(tab.id)}>
               ...
               <main className="col-lg-9 col-md-8 admin-page__main">
                  <div className="admin-page__content">{renderTabContent()}</div>
               </main>
            </div>
         </div>
      </div>
