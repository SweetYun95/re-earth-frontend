                  ...
                  <form className="registerform mt-80" onSubmit={handleSubmit}>
                     <div className="form--input">
                        ...
                        <div className="with-btn">
                           <input type="text" name="id" placeholder="4-20자, 영문 대·소문자 및 숫자" value={form.id} onChange={onChange} autoComplete="username" />
                     ...
                     <div className="form--input mt-20">
                        ...
                        <div className="with-btn">
                           <input type="text" name="nick" placeholder="닉네임을 입력하세요." value={form.nick} onChange={onChange} />
                     ...
                     <div className="form--input mt-20">
                        ...
                        <div className="password-check">
                           <input type="password" name="password" placeholder="8자 이상, 영문, 숫자, 특수문자 모두 포함" value={form.password} onChange={onChange} autoComplete="new-password" />
                           <input type="password" name="check-password" placeholder="비밀번호를 한 번 더 입력하세요." value={form.password2} onChange={onChange} autoComplete="new-password" />
                        </div>
                     </div>
