...
import { setConsent } from '../../../../features/donationSlice'
import './scss/donateform1.scss'

export default function DonateForm1({ onNext }) {
   const dispatch = useDispatch()
   const consent = useSelector((s) => s.donation.consent)
      ...
      <div className="donation--content">
         <div className="content--notice mt-80">
            ...
            <div className="notice text mt-40">
               <p>
                  ① 기증 가능물품 확인 <br />
                  기증품은 매장에서 판매되거나 사회취약계층에게 전달되고 있습니다. <br />
                  판매 수익금으로는 환경보호활동을 지원하고 있습니다. <br />
                  소중한 기증품이 잘 활용될 수 있도록 기증 가능 물품을 꼭 확인해 주세요.
                  <br />
                  <br />
                  ② 기증품 수량확인 <br />
                  기증품을 포장하시거나 수량을 확인하신 경우 방문수거는 2박스부터 가능합니다. <br />
...
`}
         ...
         <div className="content--bottom mt-40">
            <label className="content--checkbox">
               <input type="checkbox" checked={consent} onChange={handleCheck} aria-label="개인정보 수집 및 이용에 동의" />
               <p>본인은 위 내용을 확인하였으며, 개인정보 수집 및 이용에 동의합니다.</p>
            </label>

            <button className={`btn main1${consent ? '' : ' disabled'}`} onClick={handleNext} disabled={!consent} aria-disabled={!consent}>
               1/4 →
            </button>
         </div>
      </div>
