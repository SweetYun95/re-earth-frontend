...
const COMMUNITY = ['제인도가 방금 5kg의 옷을 기부했습니다.', '이번 주말에 해변 청소 이벤트가 열립니다!', '제인도가 방금 5kg의 옷을 기부했습니다.', '000님 nnnnn P 달성!']
               ...
               <div className="col-md-6">
                  <div className="row">
                     ...
                     <div className="col-md-6 mb-3">
                        <div className="custom-card">
                           <div className="text-center custom-custom-card-content">
                              <CarbonReductionCard className="carbon-reduction-card--centered" treeCount={3} totalTrees={10} />
                           </div>
                        </div>
                     </div>
