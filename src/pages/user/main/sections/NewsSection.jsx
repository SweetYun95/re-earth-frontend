...
const NEWS = [
  { 
    ...
    img: 'https://images.unsplash.com/photo-1569163139394-de6e4d2be8c4?w=300&h=200&fit=crop&crop=center',
    date: '2024.01.15'
  },
  { 
  ...
  { 
    ...
    img: 'https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=300&h=200&fit=crop&crop=center',
    date: '2024.01.10'
  },
  { 
          ...
          <div className="col-md-3 mb-4">
            <div className="h-100 d-flex flex-column justify-content-center">
              ...
              <div className="d-flex align-items-center">
                <span className="text-muted mr-2">더보기</span>
                <a 
                  href="#" 
                  className="text-dark section-arrow"
