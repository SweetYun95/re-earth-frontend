...
const MOCK_PRODUCTS = [
  {
    ...
    description: 'Stay hydrated and eco-friendly with our reusable water bottle. Made from sustainable materials, it\'s perfect for everyday use and helps reduce plastic waste. Support our mission to protect Finland\'s natural beauty with every purchase.',
    stock: 50,
    popular: true,
    specs: {
      material: '천연 대나무',
              ...
              <div className="product-info-section">
                ...
                <div className="product-actions">
                  <button 
                    ...
                    disabled={product.stock < 1 || userPoints < (product.point * quantity)}
                  >
